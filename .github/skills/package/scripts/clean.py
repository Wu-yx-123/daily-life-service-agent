"""Clean MassageOps-Agent for distribution — remove caches, venv, build artifacts, local db.
...
_WHOLE_REMOVE_DIRS = {"backend/.venv", ".venv", "venv", "env", "data", "build", "dist", "frontend/node_modules", "frontend/dist", "cache", ".cache"}
